...
const Home: React.FC = () => {
  ...
  return (
    <Grid container sx={{height:1}} justifyContent="space-between" flexDirection="column">
      <Grid item>
        {/* Search block */}
        <Box sx={searchBoxStyle}>
          <Typography variant="h1" sx={{fontSize:'1.5rem',marginBottom:'20px'}} color="primary.contrastText">
            Search
          </Typography>
